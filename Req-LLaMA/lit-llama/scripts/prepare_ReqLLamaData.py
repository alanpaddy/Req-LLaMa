...
#DATA_FILE = "https://drive.google.com/file/d/1rZg2eZtx9F9bvyZbjYlIMpJ2bkxDijQz/view?usp=share_link"
DATA_FILE = open("/gdrive/MyDrive/Transformers/LLAMA/Datasets/train.json")
DATA_FILE_NAME = "train.json"
IGNORE_INDEX = -1


def prepare(
    destination_path: Path = Path("/gdrive/MyDrive/Transformers/LLAMA/Datasets"), 
    tokenizer_path: Path = Path("/gdrive/MyDrive/Transformers/LLAMA/WEIGHTS/lit-llama/tokenizer.model"),
