...
wandb.init(
  project="llamaV1.01",
  dir="gdrive/MyDrive/Transformers/LLAMA/wandb",
  magic=True,
  config=
...
def main(
    ...
    out_dir: str = "/gdrive/MyDrive/Transformers/LLAMA/WEIGHTS/REQLLaMA",
):
    ...
    for iter_num in range(max_iters):
        ...
        if (iter_num + 1) % gradient_accumulation_steps == 0:
            ...
            if step_count % eval_interval == 0:
                ...
                wandb.log({"iterations" : iter_num,"val loss": val_loss, "learning_rate": lr})
                fabric.barrier()
